...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (Grammar.isValid())
            {
                ...
                lr1.GenerateParserForCupEntryFile("./Test4/src/Automaton/Parser/parser2.java","./Test4/src/Automaton/Parser/gsonLr1.txt");
                lr1.GenerateSymbolsDefinitionFile("./Test4/src/Automaton/Parser/sym.java");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static List<String> readFile()
    {
        ...
        try
        {
            try (BufferedReader br = new BufferedReader(new FileReader("./Test4/src/example.cup"))) {
                String line;
        ...
        {
            System.err.format("Exception occurred trying to read '%s'.", "./src/example.txt");
            e.printStackTrace();
            return null;
        }
    }

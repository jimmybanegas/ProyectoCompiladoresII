...
public class ParserMain {
    ...
    /* Start the parser */
        try {
            ...
            parser2 parser =  new parser2(new Lexer(new FileReader("./Test4/src/test.txt")));

            Tuple<Object, Object> accepted = parser.parse();

            Temp respuesta = (Temp) accepted.y;

            System.out.println("Valor : "+respuesta.getValor() +"\n" + "Profundidad: "+respuesta.getProfundidad());

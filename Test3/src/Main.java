...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (Grammar.isValid())
            {
                ...
                lr1.GenerateParserForCupEntryFile("./Test3/src/Automaton/Parser/parser2.java","./Test3/src/Automaton/Parser/gsonLr1.txt");
                lr1.GenerateSymbolsDefinitionFile("./Test3/src/Automaton/Parser/sym.java");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static List<String> readFile()
    {
        ...
        try
        {
            try (BufferedReader br = new BufferedReader(new FileReader("./Test3/src/ycalc2.cup"))) {
                String line;
